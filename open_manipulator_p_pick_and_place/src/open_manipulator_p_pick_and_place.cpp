...
#include "open_manipulator_p_pick_and_place/open_manipulator_p_pick_and_place.h"

OpenManipulatorPPickandPlace::OpenManipulatorPPickandPlace()
: node_handle_(""),
  priv_node_handle_("~"),
  mode_state_(0),
  demo_count_(0),
...
void OpenManipulatorPPickandPlace::initServiceClient()
{
...
void OpenManipulatorPPickandPlace::initSubscribe()
{
  open_manipulator_states_sub_ = node_handle_.subscribe("states", 10, &OpenManipulatorPPickandPlace::manipulatorStatesCallback, this);
  open_manipulator_joint_states_sub_ = node_handle_.subscribe("joint_states", 10, &OpenManipulatorPPickandPlace::jointStatesCallback, this);
  open_manipulator_kinematics_pose_sub_ = node_handle_.subscribe("gripper/kinematics_pose", 10, &OpenManipulatorPPickandPlace::kinematicsPoseCallback, this);
  ar_pose_marker_sub_ = node_handle_.subscribe("/ar_pose_marker", 10, &OpenManipulatorPPickandPlace::arPoseMarkerCallback, this);
}

bool OpenManipulatorPPickandPlace::setJointSpacePath(std::vector<std::string> joint_name, std::vector<double> joint_angle, double path_time)
{
...
bool OpenManipulatorPPickandPlace::setToolControl(std::vector<double> joint_angle)
{
  open_manipulator_msgs::SetJointPosition srv;
...
bool OpenManipulatorPPickandPlace::setTaskSpacePath(std::vector<double> kinematics_pose,std::vector<double> kienmatics_orientation, double path_time)
{
...
void OpenManipulatorPPickandPlace::manipulatorStatesCallback(const open_manipulator_msgs::OpenManipulatorState::ConstPtr &msg)
{
...
void OpenManipulatorPPickandPlace::jointStatesCallback(const sensor_msgs::JointState::ConstPtr &msg)
{
...
void OpenManipulatorPPickandPlace::kinematicsPoseCallback(const open_manipulator_msgs::KinematicsPose::ConstPtr &msg)
{
...
void OpenManipulatorPPickandPlace::arPoseMarkerCallback(const ar_track_alvar_msgs::AlvarMarkers::ConstPtr &msg)
{
...
void OpenManipulatorPPickandPlace::publishCallback(const ros::TimerEvent&)
{
  printText();
...
void OpenManipulatorPPickandPlace::setModeState(char ch)
{
  if (ch == '1')
...
void OpenManipulatorPPickandPlace::demoSequence()
{
  std::vector<double> joint_angle;
...
void OpenManipulatorPPickandPlace::printText()
{
  system("clear");
  printf("\n");
  printf("-----------------------------\n");
...
bool OpenManipulatorPPickandPlace::kbhit()
{
  termios term;
  tcgetattr(0, &term);
...
{
  // Init ROS node
  ros::init(argc, argv, "open_manipulator_p_pick_and_place");
  ros::NodeHandle node_handle("");

  OpenManipulatorPPickandPlace open_manipulator_p_pick_and_place;
  ros::Timer publish_timer = node_handle.createTimer(ros::Duration(0.100)/*100ms*/, &OpenManipulatorPPickandPlace::publishCallback, &open_manipulator_p_pick_and_place);
  ros::spin();
