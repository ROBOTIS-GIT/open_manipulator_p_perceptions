...
#ifndef OPEN_MANIPULATOR_P_PICK_AND_PLACE_H
#define OPEN_MANIPULATOR_P_PICK_AND_PLACE_H
...
class OpenManipulatorPPickandPlace
{
 private:
  // ROS NodeHandle
...
#endif //OPEN_MANIPULATOR_P_PICK_AND_PLACE_H
